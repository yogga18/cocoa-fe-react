  ...
  return (
    <div className='bg-white my-5'>
      <VerticalTimeline lineColor={'#6c757d'}>
        <VerticalTimelineElement
          className='vertical-timeline-element--work kill'
          contentStyle={{ background: '#0077ff', cursor: 'pointer' }}
        ...
        <VerticalTimelineElement
          ...
          contentStyle={{ background: '#0099ff', cursor: 'pointer' }}
