...
import Prov_2015 from '../../../Data/Provinsi/Prov15';
...
const Prov2015 = () => {
  ...
  const filterData = () => {
    const deleteDot = Prov_2015.map((item) => {
      return {
        ...item,
  ...
  return (
    <Fragment>
      <Container fluid className='my-5'>
        <Row className='mx-3'>
          <Col md='6'>
            Tabel Penghasil Komoditas Kakao 2015 by Kabupaten di Indonesia
          </Col>
          <Col md='6'>
            <select
