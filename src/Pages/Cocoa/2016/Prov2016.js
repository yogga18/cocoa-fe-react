...
import Prov_2016 from '../../../Data/Provinsi/Prov16';
...
const Prov2016 = () => {
  ...
  const filterData = () => {
    const deleteDot = Prov_2016.map((item) => {
      return {
        ...item,
        Luas_Areal_2016: item.Luas_Areal_2016?.replace('.', ''),
        Produksi_2016: item.Produksi_2016?.replace('.', ''),
