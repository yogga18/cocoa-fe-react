...
import Prov_2019 from '../../../Data/Provinsi/Prov19';
...
const Prov2019 = () => {
  ...
  const filterData = () => {
    const deleteDot = Prov_2019.map((item) => {
      return {
        ...item,
        Luas_Areal_2019: item.Luas_Areal_2019?.replace('.', ''),
        Produksi_2019: item.Produksi_2019?.replace('.', ''),
  ...
  return (
    <Fragment>
      <Container fluid className='my-5'>
        <Row className='mx-3'>
          <Col md='6'>
            Tabel Penghasil Komoditas Kakao 2019 by Kabupaten di Indonesia
          </Col>
          <Col md='6'>
            <select
              ...
              columns={[
                ...
                },
                {
                  ...
                  formatter: (cell) =>
                    _(
                      <>
                        {cell.Luas_Areal_2019 === '' ? (
                          <p>-</p>
                        ) : (
                          <p>{cell.Luas_Areal_2019}</p>
                        )}
                      </>
                    ),
                },
