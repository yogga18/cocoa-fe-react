...
import elbow_20 from '../../../assets/img/2020/Elbow_2020.png';
        ...
        <Container fluid>
          <Row className='mt-3'>
            ...
            <Col md='6' className='mb-5'>
              <div className='pt-5'>
                <p>
                  ...
                  <b>6.056065303286172,</b> dan dengan Cluster berjumlah 2
                  mendapatkan nilai <i>Davies-Bouldin index ( DBI )</i> sebesar{' '}
                  <b>0.5927858963328123</b>
                </p>
                <p>
            ...
            <Col md='12'>
              ...
              <p>
                Pada tahun 2020 komoditas kakao di Indonesia mengalami penurunan
                kembali yang menyebabkan provinsi yang berada di Cluster 1{' '}
                <span className='badge bg-success font-size-12'>
                  Potensi Baik
                </span>{' '}
                berkurang sebanyak 2 yaitu Provinsi Lampung dan Provinsi
                Sumatera Barat yang dikarenakan terjadi penurunan hampir
                disetiap aspeknya dan mengalami peningkatan hanya pada
                Tanaman_Damage yang menandakan bahwa 2 Provinsi tersebut
                memiliki komoditas kakao yang kurang baik dan masuk kedalam
                Cluster 0{' '}
                <span className='badge bg-warning font-size-12'>
                  Potensi Kurang Baik
                </span>
